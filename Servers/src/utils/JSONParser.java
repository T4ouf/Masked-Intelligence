...
public abstract class JSONParser {
	...
	public static String parseSTART_GAME(String msg) {
	...
	public static JoinStartedGameRequest parseJOIN_STARTED_GAME(String msg) {
		...
		try {
			...
			return new JoinStartedGameRequest((String) dataMap.get("game_id"), (int) dataMap.get("player_id"));
